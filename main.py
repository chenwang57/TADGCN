...
if __name__ == '__main__':
    ...
    parser.add_argument('--dataset', type=str, choices=['PEMS04', 'PEMS08', 'England'],
                        default='PEMS08', help='')
    ...
    # run settings
    DATASET = args_input.dataset      # PEMS04, PEMS08, England

    # load config
    config_file = './configs/{}.yaml'.format(DATASET)
    config = yaml.load(
        open(config_file),
